		...
		public Operation_Main()
		{
            ...
            switch (processType)
            {
                case Define.DefineEnumProject.AppConfig.EN_PROCESS_TYPE.BIN_SORTER:
                    {
                        MonitoringSubPanelList.Add(MonitoringSubPanelType.Digital, new EFEM.CustomizedByCustomer.UserInterface.OperationMainMonitoring.PWA500BIN.MainMonitoringSubPanel500BINDigitals());
                        MonitoringSubPanelList.Add(MonitoringSubPanelType.Analog, new EFEM.CustomizedByCustomer.UserInterface.OperationMainMonitoring.PWA500BIN.MainMonitoringSubPanel500BINAnalogs());
                    }
                    break;
                default:
                    break;
                ...
                case Define.DefineEnumProject.AppConfig.EN_PROCESS_TYPE.BIN_SORTER:
                    {
                        ...
                        AddControlToPanelInterface(MainDisplaySubPanels.Summary,
                            new EFEM.CustomizedByCustomer.UserInterface.OperationMainSummary.PWA500BIN.MainDisplaySubPanelSummary500BIN(MainDisplaySubPanels.Summary.ToString()),
                            ref addPanelList);
                        AddControlToPanelInterface(MainDisplaySubPanels.ManualOperation,
                            new EFEM.CustomizedByCustomer.UserInterface.OperationMainManual.PWA500BIN.MainDisplaySubPanelManualOperation500BIN(MainDisplaySubPanels.ManualOperation.ToString()),
                            ref addPanelList);
                    }
                    break;
                default:
