	...
	public class ConvertProjectTaskData
	{
		public static string[] GetActionListByTask(string taskName)
		{
			...
			switch (enTask)
			{
                ...
                case Define.DefineEnumProject.Task.EN_TASK_LIST.LoadPort6:
					return Enum.GetNames(typeof(FrameOfSystem3.Task.TaskLoadPort.TASK_ACTION));
				default:
					return new string[] { string.Empty };
			}
		}
		public static string[] GetAxisListByTask(string taskName)
		{
			...
			switch (enTask)
			{
                ...
                case Define.DefineEnumProject.Task.EN_TASK_LIST.LoadPort5:
                case Define.DefineEnumProject.Task.EN_TASK_LIST.LoadPort6:
					return Enum.GetNames(typeof(Define.DefineEnumProject.Task.LoadPort.EN_AXIS));
                case Define.DefineEnumProject.Task.EN_TASK_LIST.AtmRobot:
                    return Enum.GetNames(typeof(Define.DefineEnumProject.Task.AtmRobot.EN_AXIS));
                default:
					return new string[] { string.Empty };
			}
		}
		public static bool IsDefinedParameter(Define.DefineEnumProject.Task.EN_TASK_LIST enTask, string parameterName)
		{
			...
			switch (enTask)
			{
                ...
                case Define.DefineEnumProject.Task.EN_TASK_LIST.LoadPort5:
                case Define.DefineEnumProject.Task.EN_TASK_LIST.LoadPort6:
					type = typeof(Define.DefineEnumProject.Task.LoadPort.PARAM_PROCESS);
					break;
                case Define.DefineEnumProject.Task.EN_TASK_LIST.AtmRobot:
                    type = typeof(Define.DefineEnumProject.Task.AtmRobot.PARAM_PROCESS);
                    break;

                case Define.DefineEnumProject.Task.EN_TASK_LIST.Global:
					type = typeof(Define.DefineEnumProject.Task.Global.PARAM_GLOBAL);
					break;
				default:
					return false;
			}
