                ...
                case EN_INITIALIZATION_STEP.INIT_EFEM_MODULES_END:
                    {
                                ...
                                case Define.DefineEnumProject.AppConfig.EN_PIO_INTERFACE_TYPE.E84:
                                    {
                                        ...
                                        int saftyInterLockIndex = (int)Define.DefineEnumProject.DigitalIO.EN_DIGITAL_IN.PROTECTION_BAR_LP;

                                        int baseInputIndex = (int)Define.DefineEnumProject.DigitalIO.EN_DIGITAL_IN.LP1_PIO_VALID + i * Offset;
                                        int baseOutputIndex = (int)Define.DefineEnumProject.DigitalIO.EN_DIGITAL_OUT.LP1_PIO_L_REQ + i * Offset;
                                ...
                                case Define.DefineEnumProject.AppConfig.EN_PIO_INTERFACE_TYPE.E23:
                                    {
                                        ...
                                        int saftyInterLockIndex = (int)Define.DefineEnumProject.DigitalIO.EN_DIGITAL_IN.PROTECTION_BAR_LP + interLockOffset;
                                ...
                                case Define.DefineEnumProject.AppConfig.EN_PROCESS_TYPE.BIN_SORTER:
                                    {
                                        ...
                                        EFEM.CustomizedByCustomer.PWA500BIN.LoadPortType loadPortType = (EFEM.CustomizedByCustomer.PWA500BIN.LoadPortType)i;
                                        switch (loadPortType)
                                        {
                                            case EFEM.CustomizedByCustomer.PWA500BIN.LoadPortType.Bin_3:
                                            case EFEM.CustomizedByCustomer.PWA500BIN.LoadPortType.Bin_2:
                                            case EFEM.CustomizedByCustomer.PWA500BIN.LoadPortType.Bin_1:
                                                scheduler = new EFEM.CustomizedByCustomer.PWA500BIN.BinLoadPortActionScheduler(i);
                                                break;
                                            case EFEM.CustomizedByCustomer.PWA500BIN.LoadPortType.EmptyTape:
                                                scheduler = new EFEM.CustomizedByCustomer.PWA500BIN.EmptyTapeLoadPortActionScheduler(i);
                                                break;
                                            case EFEM.CustomizedByCustomer.PWA500BIN.LoadPortType.Core_2:
                                            case EFEM.CustomizedByCustomer.PWA500BIN.LoadPortType.Core_1:
                                                scheduler = new EFEM.CustomizedByCustomer.PWA500BIN.CoreLoadPortActionScheduler(i);
                                                break;
                                            default:
                                                break;
                                        }
                        ...
                        for (i = 0; i < countRobot; ++i)
                        {
                            ...
                            switch (processType)
                            {
                                case Define.DefineEnumProject.AppConfig.EN_PROCESS_TYPE.NONE:
                                case Define.DefineEnumProject.AppConfig.EN_PROCESS_TYPE.BIN_SORTER:
                                    scheduler = new EFEM.CustomizedByCustomer.PWA500BIN.PWA500BinSorterRobotActionScheduler(i);
                                    break;
                                default:
                                    break;
                            }
                        ...
                        for (i = 0; i < countProcessModule; ++i)
                        {
                            ...
                            switch (ProcessType)
                            {
                                ...
                                case Define.DefineEnumProject.AppConfig.EN_PROCESS_TYPE.BIN_SORTER:
                                    {
                                        communicator = new EFEM.CustomizedByCustomer.PWA500BIN.PWA500BINCommunicator(locationNames, simulation);
                                        module = new EFEM.CustomizedByCustomer.PWA500BIN.ProcessModulePWA500BIN(i, communicator, name, locationNames, simulation);
                                    }
                                    break;
                                default:
                                    break;
