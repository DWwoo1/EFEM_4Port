...
{
	class TaskGlobal : RunningTaskWrapper
	{
		#region constructor
        ...
        {
			DoorOpenedSensors[(int)EN_DIGITAL_IN.EFEM_DOOR_CLOSE] = false;
        }
		private void MappingFanAlarmSensor()
        {
			FanAlarmSensors[(int)EN_DIGITAL_IN.EFEM_POWER_BOX_FAN_STATUS] = false;
			FanAlarmSensors[(int)EN_DIGITAL_IN.EFEM_IO_BOX_FAN_STATUS] = false;
			FanAlarmSensors[(int)EN_DIGITAL_IN.ROBOT_CONTROLLER_FAN_ALARM] = false;
		}
		private void MappingFFUAlarm()
        {
			FFUAlarms[(int)EN_DIGITAL_IN.FFU_ALARM] = false;
        }
		private void MappingIonizerAlarm()
        {
			IonizerAlarms[(int)EN_DIGITAL_IN.IONIZER_1_ALARM_STATUS] = false;
			IonizerAlarms[(int)EN_DIGITAL_IN.IONIZER_2_ALARM_STATUS] = false;
			IonizerAlarms[(int)EN_DIGITAL_IN.IONIZER_3_ALARM_STATUS] = false;
		}
		private void MappingAirAlarm()
        {
            AirAlarms[(int)EN_DIGITAL_IN.EFEM_MAIN_CDA_PRESSURE_SWITCH] = false;
            AirAlarms[(int)EN_DIGITAL_IN.EFEM_MAIN_VACUUM_PRESSURE_SWITCH] = false;
            AirAlarms[(int)EN_DIGITAL_IN.ROBOT_CDA_PRESSURE_SWITCH] = false;
            AirAlarms[(int)EN_DIGITAL_IN.IONIZER_CDA_PRESSURE_SWITCH] = false;
            AirAlarms[(int)EN_DIGITAL_IN.IONIZER_1_FLOW_METER] = false;
            AirAlarms[(int)EN_DIGITAL_IN.IONIZER_2_FLOW_METER] = false;
            AirAlarms[(int)EN_DIGITAL_IN.IONIZER_3_FLOW_METER] = false;
        }
