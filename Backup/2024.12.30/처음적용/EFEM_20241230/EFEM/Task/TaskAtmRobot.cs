...
namespace FrameOfSystem3.Task
{
    abstract class TaskAtmRobot : RunningTaskWrapper
    {
            ...
            : base(nIndexOfTask, strTaskName, typeof(PARAM_PROCESS))
        {
            ...
            BusyStatusIndex = (int)Define.DefineEnumProject.DigitalIO.EN_DIGITAL_IN.ROBOT_BUSY_STATUS;
            AlarmStatusIndex = (int)Define.DefineEnumProject.DigitalIO.EN_DIGITAL_IN.ROBOT_ALARM_STATUS;
        ...
        protected const int CountArms = 2;
        ...
        protected readonly int AlarmStatusIndex;
        ...
        protected bool IsAtmRobotBusy()
        {
            return DigitalIO_.DigitalIO.GetInstance().ReadInput(BusyStatusIndex);
        }
        protected bool IsAtmRobotAlarm()
        {
            return DigitalIO_.DigitalIO.GetInstance().ReadInput(AlarmStatusIndex);
        }
