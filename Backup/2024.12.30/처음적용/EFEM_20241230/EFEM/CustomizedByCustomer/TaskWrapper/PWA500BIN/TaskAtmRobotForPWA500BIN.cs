...
namespace FrameOfSystem3.Task
{
    class TaskAtmRobotForPWA500BIN : TaskAtmRobot
    {
        ...
        public TaskAtmRobotForPWA500BIN(int nIndexOfTask, string strTaskName)
            : base(nIndexOfTask, strTaskName, new TaskAtmRobotRecovery(strTaskName, nIndexOfTask))
        {
        ...
        private const ScenarioListTypes ScenarioUploadBinFile = ScenarioListTypes.SCENARIO_REQ_UPLOAD_BINFILE;
                ...
                case SubstrateType.Bin3:
                    {
                        if (location is LoadPortLocation)
                        {
                            ...
                            // 6. Uploading Bin File Event
                            QueuedScenarioForBinSubstrate.Enqueue(ScenarioUploadBinFile);
                        }
                    }
                    break;
                default:
    ...
    class TaskAtmRobotRecovery : Work.RecoveryData
    {
        public TaskAtmRobotRecovery(string taskName, int nPortCount)
