...
namespace FrameOfSystem3.Task
{
    class TaskLoadPortForPWA500BIN : TaskLoadPort
    {
        ...
        public TaskLoadPortForPWA500BIN(int nIndexOfTask, string strTaskName)
            : base(nIndexOfTask, strTaskName, new TaskLoadPortRecovery(strTaskName, nIndexOfTask))
        {
            if (PortId > 3)
            {
            ...
            _recovery = _recoveryData as TaskLoadPortRecovery;
        }
        ...
        private static TaskLoadPortRecovery _recovery;
        ...
        bool NeedExecuteToScenario
        {
            get
            {
                return (_recovery.AccessStatus.Equals(CarrierAccessStates.NotAccessed) ||
                    _recovery.AccessStatus.Equals(CarrierAccessStates.Unknown));
            }
        }
    ...
    class TaskLoadPortRecovery : Work.RecoveryData
    {
