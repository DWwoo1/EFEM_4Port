                ...
                case PanelMode.Load:
                    {
                        if (substrateType.Equals(SubstrateTypeForControl.Core))
                        {
                            ...
                            else
                            {
                                ...
                                if (false == _locationServer.GetProcessModuleLocation(processModuleName, destinationName[(int)ProcessModuleEntryWays.CoreIn], ref targetLocationPm))
                                    return false;
                        ...
                        if (substrateType.Equals(SubstrateTypeForControl.EmptyTape))
                        {
                            ...
                            else
                            {
                                ...
                                ProcessModuleLocation targetLocationPm = new ProcessModuleLocation("", "");
                                string processModuleName = _processGroup.GetProcessModuleName(ProcessModuleIndex);
                                if (false == _locationServer.GetProcessModuleLocation(processModuleName, destinationName[(int)ProcessModuleEntryWays.SortIn], ref targetLocationPm))
                                    return false;
                ...
                case PanelMode.Unload:
                    {
                        ...
                        if (substrateType.Equals(SubstrateTypeForControl.Core))
                        {
                            if (pickAction)
                            {
                                ...
                                ProcessModuleLocation targetLocationPm = new ProcessModuleLocation("", "");
                                string processModuleName = _processGroup.GetProcessModuleName(ProcessModuleIndex);
                                if (false == _locationServer.GetProcessModuleLocation(processModuleName, destinationName[(int)ProcessModuleEntryWays.CoreOut], ref targetLocationPm))
                                    return false;
                        ...
                        if (substrateType.Equals(SubstrateTypeForControl.Bin))
                        {
                            if (pickAction)
                            {
                                ...
                                ProcessModuleLocation targetLocationPm = new ProcessModuleLocation("", "");
                                string processModuleName = _processGroup.GetProcessModuleName(ProcessModuleIndex);
                                if (false == _locationServer.GetProcessModuleLocation(processModuleName, destinationName[(int)ProcessModuleEntryWays.SortOut], ref targetLocationPm))
                                    return false;
