...
{
    public partial class SetupProcessModulePWA500W : UserControlForMainView.CustomView
    {
        #region <Constructors>
        public SetupProcessModulePWA500W()
        {
            InitializeComponent();
            ...
            foreach (var item in LoadPortPanels)
            {
                ...
                ParameterGroupPanel groupPanel = new ParameterGroupPanel(new SetupPWA500WLoadPortOptions(item.Key));
...

            {
                ...
                ParameterGroupPanel groupPanel = new ParameterGroupPanel(new SetupPWA500WOptions(name));
                groupPanel.Dock = DockStyle.Fill;
                groupPanel.DisableGroupBox();
                panels[name].Add(groupPanel);
                ...
                PanelInterfaces[index].InitializeSubPanels(pnPWA500WOptions, panels, name);
            }
            InitGridViews();
