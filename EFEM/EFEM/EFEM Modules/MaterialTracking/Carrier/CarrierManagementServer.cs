        ...
        public void CreateCarrier(int portId, Dictionary<int, LoadPortLocation> locations)
        {
            ...
            switch (processType)
            {
                case Define.DefineEnumProject.AppConfig.EN_PROCESS_TYPE.BIN_SORTER:
                    attribute = new CustomizedByProcessType.PWA500BIN.PWA500BINCarrierAttributes(portId);
                    break;
                case Define.DefineEnumProject.AppConfig.EN_PROCESS_TYPE.DIE_TRANSFER:
                    attribute = new CustomizedByProcessType.PWA500W.PWA500WCarrierAttributes(portId);
                    break;
                default:
                    break;
            }
