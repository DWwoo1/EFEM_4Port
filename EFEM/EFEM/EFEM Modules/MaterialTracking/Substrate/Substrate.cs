        ...
        public Substrate(string name)
        {
            ...
            switch (AppConfigManager.Instance.ProcessType)
            {
                ...
                case Define.DefineEnumProject.AppConfig.EN_PROCESS_TYPE.BIN_SORTER:
                    AdditionalAttributes = new EFEM.CustomizedByProcessType.PWA500BIN.PWA500BINAttributes();
                    break;
                case Define.DefineEnumProject.AppConfig.EN_PROCESS_TYPE.DIE_TRANSFER:
                    AdditionalAttributes = new CustomizedByProcessType.PWA500W.PWA500WAttributes();
                    break;
