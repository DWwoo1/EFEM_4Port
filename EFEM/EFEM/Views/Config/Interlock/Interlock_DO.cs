...
//             UpdateInterLockCompareItemList();
        ...
        private void UpdateInterLockConditionList()
        {
            ...
            if (m_InstanceOfInterlock.GetDOInterLockConditionList(m_nSelectedDO, EN_INTERLOCK_PARAMTER_TYPE.COMPARE_KEY, ref arCompareKey)
             && m_InstanceOfInterlock.GetDOInterLockConditionList(m_nSelectedDO, EN_INTERLOCK_PARAMTER_TYPE.DIRECTION, ref arDirection))
            {
            ...
            switch (nColumnIndex)
            {
                ...
                case 1:
                               ...
                               , bDirection ? SelectionList.TRUE : SelectionList.FALSE))
                    {
                        ...
                        m_InstanceOfConfigInterlock.SetDOInterlockCondition(m_nSelectedDO, m_nSelectedRowInterlockCondition, EN_INTERLOCK_PARAMTER_TYPE.DIRECTION, bDirection);
                    }
                    break;
            }
            UpdateInterLockConditionList();
