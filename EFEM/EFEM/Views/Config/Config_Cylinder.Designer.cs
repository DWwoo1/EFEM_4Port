namespace FrameOfSystem3.Views.Config
{
    partial class Config_Cylinder
    {
        ...
        private void InitializeComponent()
        {
			...
			this._groupBox_InputIOList = new Sys3Controls.Sys3GroupBoxContainer();
			this._tableLayoutPanel_InputIOList = new System.Windows.Forms.TableLayoutPanel();
			...
			this._groupBox_OutputIOList = new Sys3Controls.Sys3GroupBoxContainer();
			this._tableLayoutPanel_OutputList = new System.Windows.Forms.TableLayoutPanel();
			this._tableLayoutPanel_Main = new System.Windows.Forms.TableLayoutPanel();
			this._tableLayoutPanel_Timeout = new System.Windows.Forms.TableLayoutPanel();
			this._tableLayoutPanel_Delay = new System.Windows.Forms.TableLayoutPanel();
			...
			this._groupBox_InputIOList.SuspendLayout();
			this._tableLayoutPanel_InputIOList.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.m_dgViewOutput)).BeginInit();
			this._groupBox_OutputIOList.SuspendLayout();
			this._tableLayoutPanel_OutputList.SuspendLayout();
			this._tableLayoutPanel_Main.SuspendLayout();
			this._tableLayoutPanel_Timeout.SuspendLayout();
			this._tableLayoutPanel_Delay.SuspendLayout();
			...
			this.m_ledRepeat.Dock = System.Windows.Forms.DockStyle.Fill;
			this.m_ledRepeat.Location = new System.Drawing.Point(649, 7);
			this.m_ledRepeat.Margin = new System.Windows.Forms.Padding(0, 3, 0, 3);
			this.m_ledRepeat.Name = "m_ledRepeat";
			this.m_ledRepeat.Size = new System.Drawing.Size(20, 81);
			...
			dataGridViewCellStyle55.Font = new System.Drawing.Font("맑은 고딕", 11F, System.Drawing.FontStyle.Bold);
			...
			this.m_dgViewCylinder.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle55;
			...
			dataGridViewCellStyle56.Font = new System.Drawing.Font("맑은 고딕", 10F, System.Drawing.FontStyle.Bold);
			dataGridViewCellStyle56.ForeColor = System.Drawing.SystemColors.ControlText;
			dataGridViewCellStyle56.SelectionBackColor = System.Drawing.Color.FromArgb(((int)(((byte)(120)))), ((int)(((byte)(130)))), ((int)(((byte)(150)))));
			dataGridViewCellStyle56.SelectionForeColor = System.Drawing.SystemColors.HighlightText;
			dataGridViewCellStyle56.WrapMode = System.Windows.Forms.DataGridViewTriState.False;
			this.m_dgViewCylinder.DefaultCellStyle = dataGridViewCellStyle56;
			this.m_dgViewCylinder.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			this.m_dgViewCylinder.Location = new System.Drawing.Point(3, 34);
			...
			dataGridViewCellStyle57.Font = new System.Drawing.Font("맑은 고딕", 11F);
			dataGridViewCellStyle57.ForeColor = System.Drawing.SystemColors.WindowText;
			dataGridViewCellStyle57.SelectionBackColor = System.Drawing.Color.FromArgb(((int)(((byte)(120)))), ((int)(((byte)(130)))), ((int)(((byte)(150)))));
			dataGridViewCellStyle57.SelectionForeColor = System.Drawing.SystemColors.HighlightText;
			dataGridViewCellStyle57.WrapMode = System.Windows.Forms.DataGridViewTriState.True;
			this.m_dgViewCylinder.RowHeadersDefaultCellStyle = dataGridViewCellStyle57;
			...
			this.m_dgViewCylinder.Size = new System.Drawing.Size(1150, 369);
			...
			this.m_labelMonitoring.Description = "";
			this.m_labelMonitoring.DisabledColor = System.Drawing.Color.LightGray;
			this.m_labelMonitoring.Dock = System.Windows.Forms.DockStyle.Fill;
			this.m_labelMonitoring.EdgeRadius = 1;
			this.m_labelMonitoring.Enabled = false;
			this.m_labelMonitoring.ImagePosition = new System.Drawing.Point(0, 0);
			this.m_labelMonitoring.ImageSize = new System.Drawing.Point(0, 0);
			this.m_labelMonitoring.LoadImage = null;
			this.m_labelMonitoring.Location = new System.Drawing.Point(926, 46);
			...
			this.m_labelMonitoring.Margin = new System.Windows.Forms.Padding(1);
			this.m_labelMonitoring.Name = "m_labelMonitoring";
			this.m_labelMonitoring.Size = new System.Drawing.Size(202, 43);
			...
			this.m_labelMonitoring.ThemeIndex = 0;
			...
			this.m_labelMonitoring.UseImage = false;
			...
			this._tableLayoutPanel_Configuration.SetColumnSpan(this.m_labelState, 2);
			...
			this.m_labelState.Location = new System.Drawing.Point(496, 46);
			...
			this.m_labelState.Size = new System.Drawing.Size(276, 43);
			...
			this.m_labelTimeout.Location = new System.Drawing.Point(218, 4);
			...
			this.m_labelTimeout.Margin = new System.Windows.Forms.Padding(2);
			this.m_labelTimeout.Name = "m_labelTimeout";
			this.m_labelTimeout.Size = new System.Drawing.Size(348, 44);
			...
			this.m_labelDelay.Description = "";
			this.m_labelDelay.DisabledColor = System.Drawing.Color.LightGray;
			this.m_labelDelay.Dock = System.Windows.Forms.DockStyle.Fill;
			this.m_labelDelay.EdgeRadius = 1;
			this.m_labelDelay.Enabled = false;
			this.m_labelDelay.ImagePosition = new System.Drawing.Point(0, 0);
			this.m_labelDelay.ImageSize = new System.Drawing.Point(0, 0);
			this.m_labelDelay.LoadImage = null;
			this.m_labelDelay.Location = new System.Drawing.Point(218, 4);
			...
			this.m_labelDelay.Margin = new System.Windows.Forms.Padding(2);
			this.m_labelDelay.Name = "m_labelDelay";
			this.m_labelDelay.Size = new System.Drawing.Size(348, 44);
			...
			this.m_labelDelay.ThemeIndex = 0;
			...
			this.m_labelDelay.UseImage = false;
			...
			this._tableLayoutPanel_Configuration.SetColumnSpan(this.m_labelName, 2);
			...
			this.m_labelName.Location = new System.Drawing.Point(774, 1);
			...
			this.m_labelName.Size = new System.Drawing.Size(354, 43);
			...
			this.m_labelKey.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			this.m_labelKey.Location = new System.Drawing.Point(496, 1);
			...
			this.m_labelKey.Margin = new System.Windows.Forms.Padding(1);
			this.m_labelKey.Name = "m_labelKey";
			this.m_labelKey.Size = new System.Drawing.Size(124, 43);
			...
			this.m_groupList.Controls.Add(this.m_btnExtend);
			this.m_groupList.Controls.Add(this.m_dgViewCylinder);
			...
			this.m_groupList.Padding = new System.Windows.Forms.Padding(3, 20, 3, 3);
			this.m_groupList.Size = new System.Drawing.Size(1156, 406);
			...
			this._tableLayoutPanel_Main.SetColumnSpan(this.m_groupConfiguration, 2);
			...
			this.m_groupConfiguration.Location = new System.Drawing.Point(0, 406);
			...
			this.m_groupConfiguration.Size = new System.Drawing.Size(1156, 129);
			...
			this._tableLayoutPanel_Configuration.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 1.341143F));
			this._tableLayoutPanel_Configuration.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 12.75912F));
			this._tableLayoutPanel_Configuration.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 12.75912F));
			this._tableLayoutPanel_Configuration.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 3.209805F));
			this._tableLayoutPanel_Configuration.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 13.26533F));
			this._tableLayoutPanel_Configuration.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 11.02069F));
			this._tableLayoutPanel_Configuration.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 13.26533F));
			this._tableLayoutPanel_Configuration.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 13.26533F));
			this._tableLayoutPanel_Configuration.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 17.77299F));
			this._tableLayoutPanel_Configuration.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 1.341144F));
			this._tableLayoutPanel_Configuration.Controls.Add(this.m_tabForward, 1, 1);
			this._tableLayoutPanel_Configuration.Controls.Add(this.m_tabBackward, 2, 1);
			this._tableLayoutPanel_Configuration.Controls.Add(this.m_lblName, 6, 1);
			this._tableLayoutPanel_Configuration.Controls.Add(this.m_lblMonitoring, 7, 2);
			this._tableLayoutPanel_Configuration.Controls.Add(this.m_lblKey, 4, 1);
			this._tableLayoutPanel_Configuration.Controls.Add(this.m_labelKey, 5, 1);
			this._tableLayoutPanel_Configuration.Controls.Add(this.m_lblState, 4, 2);
			this._tableLayoutPanel_Configuration.Controls.Add(this.m_labelState, 5, 2);
			this._tableLayoutPanel_Configuration.Controls.Add(this.m_labelName, 7, 1);
			this._tableLayoutPanel_Configuration.Controls.Add(this.m_labelMonitoring, 8, 2);
			this._tableLayoutPanel_Configuration.Dock = System.Windows.Forms.DockStyle.Fill;
			this._tableLayoutPanel_Configuration.Location = new System.Drawing.Point(3, 34);
			this._tableLayoutPanel_Configuration.Name = "_tableLayoutPanel_Configuration";
			this._tableLayoutPanel_Configuration.RowCount = 4;
			this._tableLayoutPanel_Configuration.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 0.9803922F));
			this._tableLayoutPanel_Configuration.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 49.01961F));
			this._tableLayoutPanel_Configuration.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 49.01961F));
			this._tableLayoutPanel_Configuration.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 0.9803922F));
			this._tableLayoutPanel_Configuration.Size = new System.Drawing.Size(1150, 92);
			...
			this.m_tabBackward.ClickedEmphasizeTextColor = System.Drawing.Color.White;
			this.m_tabBackward.CustomClickedGradientFirstColor = System.Drawing.Color.White;
			this.m_tabBackward.CustomClickedGradientSecondColor = System.Drawing.Color.White;
			this.m_tabBackward.Description = "";
			this.m_tabBackward.DisabledColor = System.Drawing.Color.DarkGray;
			this.m_tabBackward.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			this.m_tabBackward.HoverEmphasizeCustomColor = System.Drawing.Color.White;
			...
			this.m_tabBackward.Location = new System.Drawing.Point(161, 0);
			...
			this.m_tabBackward.Margin = new System.Windows.Forms.Padding(0);
			this.m_tabBackward.Name = "m_tabBackward";
			this._tableLayoutPanel_Configuration.SetRowSpan(this.m_tabBackward, 2);
			this.m_tabBackward.Size = new System.Drawing.Size(146, 90);
			...
			this.m_tabBackward.ThemeIndex = 0;
			this.m_tabBackward.UseBorder = false;
			this.m_tabBackward.UseClickedEmphasizeTextColor = false;
			this.m_tabBackward.UseCustomizeClickedColor = false;
			this.m_tabBackward.UseEdge = false;
			this.m_tabBackward.UseHoverEmphasizeCustomColor = false;
			this.m_tabBackward.UseImage = false;
			this.m_tabBackward.UserHoverEmpahsize = false;
			...
			this.m_tabForward.ClickedEmphasizeTextColor = System.Drawing.Color.White;
			this.m_tabForward.CustomClickedGradientFirstColor = System.Drawing.Color.White;
			this.m_tabForward.CustomClickedGradientSecondColor = System.Drawing.Color.White;
			this.m_tabForward.Description = "";
			this.m_tabForward.DisabledColor = System.Drawing.Color.DarkGray;
			this.m_tabForward.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			this.m_tabForward.HoverEmphasizeCustomColor = System.Drawing.Color.White;
			...
			this.m_tabForward.Location = new System.Drawing.Point(15, 0);
			...
			this.m_tabForward.Margin = new System.Windows.Forms.Padding(0);
			this.m_tabForward.Name = "m_tabForward";
			this._tableLayoutPanel_Configuration.SetRowSpan(this.m_tabForward, 2);
			this.m_tabForward.Size = new System.Drawing.Size(146, 90);
			...
			this.m_tabForward.ThemeIndex = 0;
			this.m_tabForward.UseBorder = false;
			this.m_tabForward.UseClickedEmphasizeTextColor = false;
			this.m_tabForward.UseCustomizeClickedColor = false;
			this.m_tabForward.UseEdge = false;
			this.m_tabForward.UseHoverEmphasizeCustomColor = false;
			this.m_tabForward.UseImage = false;
			this.m_tabForward.UserHoverEmpahsize = false;
			...
			this.m_lblName.Location = new System.Drawing.Point(622, 1);
			...
			this.m_lblName.Size = new System.Drawing.Size(150, 43);
			...
			this.m_lblMonitoring.Description = "";
			this.m_lblMonitoring.DisabledColor = System.Drawing.Color.DarkGray;
			this.m_lblMonitoring.Dock = System.Windows.Forms.DockStyle.Fill;
			this.m_lblMonitoring.EdgeRadius = 1;
			this.m_lblMonitoring.ImagePosition = new System.Drawing.Point(0, 0);
			this.m_lblMonitoring.ImageSize = new System.Drawing.Point(0, 0);
			this.m_lblMonitoring.LoadImage = null;
			this.m_lblMonitoring.Location = new System.Drawing.Point(774, 46);
			...
			this.m_lblMonitoring.Margin = new System.Windows.Forms.Padding(1);
			this.m_lblMonitoring.Name = "m_lblMonitoring";
			this.m_lblMonitoring.Size = new System.Drawing.Size(150, 43);
			...
			this.m_lblMonitoring.ThemeIndex = 0;
			...
			this.m_lblMonitoring.UseImage = false;
			...
			this.m_lblKey.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			this.m_lblKey.Location = new System.Drawing.Point(344, 1);
			...
			this.m_lblKey.Margin = new System.Windows.Forms.Padding(1);
			this.m_lblKey.Name = "m_lblKey";
			this.m_lblKey.Size = new System.Drawing.Size(150, 43);
			...
			this.m_lblState.Location = new System.Drawing.Point(344, 46);
			...
			this.m_lblState.Size = new System.Drawing.Size(150, 43);
			...
			this.m_lblDelay.Description = "";
			this.m_lblDelay.DisabledColor = System.Drawing.Color.DarkGray;
			this.m_lblDelay.Dock = System.Windows.Forms.DockStyle.Fill;
			this.m_lblDelay.EdgeRadius = 1;
			this.m_lblDelay.ImagePosition = new System.Drawing.Point(0, 0);
			this.m_lblDelay.ImageSize = new System.Drawing.Point(0, 0);
			this.m_lblDelay.LoadImage = null;
			this.m_lblDelay.Location = new System.Drawing.Point(2, 4);
			...
			this.m_lblDelay.Margin = new System.Windows.Forms.Padding(2);
			this.m_lblDelay.Name = "m_lblDelay";
			this.m_lblDelay.Size = new System.Drawing.Size(212, 44);
			...
			this.m_lblDelay.UseImage = false;
			...
			this.m_lblTimeout.Location = new System.Drawing.Point(2, 4);
			...
			this.m_lblTimeout.Margin = new System.Windows.Forms.Padding(2);
			this.m_lblTimeout.Name = "m_lblTimeout";
			this.m_lblTimeout.Size = new System.Drawing.Size(212, 44);
			...
			this.m_btnDisable.Location = new System.Drawing.Point(174, 7);
			...
			this.m_btnDisable.Size = new System.Drawing.Size(130, 81);
			...
			this.m_btnEnable.Location = new System.Drawing.Point(38, 7);
			...
			this.m_btnEnable.Size = new System.Drawing.Size(130, 81);
			...
			this.m_btnBackward.ClickedEmphasizeTextColor = System.Drawing.Color.White;
			this.m_btnBackward.CustomClickedGradientFirstColor = System.Drawing.Color.White;
			this.m_btnBackward.CustomClickedGradientSecondColor = System.Drawing.Color.White;
			this.m_btnBackward.Description = "";
			this.m_btnBackward.DisabledColor = System.Drawing.Color.DarkGray;
			this.m_btnBackward.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			this.m_btnBackward.HoverEmphasizeCustomColor = System.Drawing.Color.White;
			...
			this.m_btnBackward.Location = new System.Drawing.Point(979, 7);
			...
			this.m_btnBackward.Size = new System.Drawing.Size(130, 81);
			...
			this.m_btnBackward.ThemeIndex = 0;
			this.m_btnBackward.UseBorder = true;
			this.m_btnBackward.UseClickedEmphasizeTextColor = false;
			this.m_btnBackward.UseCustomizeClickedColor = false;
			this.m_btnBackward.UseEdge = true;
			this.m_btnBackward.UseHoverEmphasizeCustomColor = false;
			this.m_btnBackward.UseImage = false;
			this.m_btnBackward.UserHoverEmpahsize = false;
			...
			this.m_btnForward.ClickedEmphasizeTextColor = System.Drawing.Color.White;
			this.m_btnForward.CustomClickedGradientFirstColor = System.Drawing.Color.White;
			this.m_btnForward.CustomClickedGradientSecondColor = System.Drawing.Color.White;
			this.m_btnForward.Description = "";
			this.m_btnForward.DisabledColor = System.Drawing.Color.DarkGray;
			this.m_btnForward.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			this.m_btnForward.HoverEmphasizeCustomColor = System.Drawing.Color.White;
			...
			this.m_btnForward.Location = new System.Drawing.Point(843, 7);
			...
			this.m_btnForward.Size = new System.Drawing.Size(130, 81);
			...
			this.m_btnForward.ThemeIndex = 0;
			this.m_btnForward.UseBorder = true;
			this.m_btnForward.UseClickedEmphasizeTextColor = false;
			this.m_btnForward.UseCustomizeClickedColor = false;
			this.m_btnForward.UseEdge = true;
			this.m_btnForward.UseHoverEmphasizeCustomColor = false;
			this.m_btnForward.UseImage = false;
			this.m_btnForward.UserHoverEmpahsize = false;
			...
			this.m_btnRepeat.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			this.m_btnRepeat.Location = new System.Drawing.Point(669, 7);
			...
			this.m_btnRepeat.Margin = new System.Windows.Forms.Padding(0, 3, 3, 3);
			this.m_btnRepeat.Name = "m_btnRepeat";
			this.m_btnRepeat.Size = new System.Drawing.Size(133, 81);
			...
			this.m_btnRemove.Location = new System.Drawing.Point(481, 7);
			...
			this.m_btnRemove.Size = new System.Drawing.Size(130, 81);
			...
			this.m_btnAdd.Location = new System.Drawing.Point(345, 7);
			...
			this.m_btnAdd.Size = new System.Drawing.Size(130, 81);
			...
			dataGridViewCellStyle58.Font = new System.Drawing.Font("맑은 고딕", 11F, System.Drawing.FontStyle.Bold);
			...
			this.m_dgViewINPUT.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle58;
			...
			dataGridViewCellStyle59.Font = new System.Drawing.Font("맑은 고딕", 10F, System.Drawing.FontStyle.Bold);
			dataGridViewCellStyle59.ForeColor = System.Drawing.SystemColors.ControlText;
			dataGridViewCellStyle59.SelectionBackColor = System.Drawing.Color.FromArgb(((int)(((byte)(120)))), ((int)(((byte)(130)))), ((int)(((byte)(150)))));
			dataGridViewCellStyle59.SelectionForeColor = System.Drawing.SystemColors.HighlightText;
			dataGridViewCellStyle59.WrapMode = System.Windows.Forms.DataGridViewTriState.False;
			this.m_dgViewINPUT.DefaultCellStyle = dataGridViewCellStyle59;
			...
			this.m_dgViewINPUT.Location = new System.Drawing.Point(0, 0);
			this.m_dgViewINPUT.Margin = new System.Windows.Forms.Padding(0);
			...
			dataGridViewCellStyle60.Font = new System.Drawing.Font("맑은 고딕", 11F);
			dataGridViewCellStyle60.ForeColor = System.Drawing.SystemColors.WindowText;
			dataGridViewCellStyle60.SelectionBackColor = System.Drawing.Color.FromArgb(((int)(((byte)(120)))), ((int)(((byte)(130)))), ((int)(((byte)(150)))));
			dataGridViewCellStyle60.SelectionForeColor = System.Drawing.SystemColors.HighlightText;
			dataGridViewCellStyle60.WrapMode = System.Windows.Forms.DataGridViewTriState.True;
			this.m_dgViewINPUT.RowHeadersDefaultCellStyle = dataGridViewCellStyle60;
			...
			this._tableLayoutPanel_InputIOList.SetRowSpan(this.m_dgViewINPUT, 4);
			...
			this.m_dgViewINPUT.Size = new System.Drawing.Size(439, 169);
			...
			// 
			// _groupBox_InputIOList
			// 
			this._groupBox_InputIOList.BackGroundColor = System.Drawing.Color.WhiteSmoke;
			this._groupBox_InputIOList.Controls.Add(this._tableLayoutPanel_InputIOList);
			this._groupBox_InputIOList.Dock = System.Windows.Forms.DockStyle.Fill;
			this._groupBox_InputIOList.EdgeBorderStroke = 2;
			this._groupBox_InputIOList.EdgeRadius = 2;
			this._groupBox_InputIOList.LabelFont = new System.Drawing.Font("맑은 고딕", 10F, System.Drawing.FontStyle.Bold);
			this._groupBox_InputIOList.LabelGradientColorFirst = System.Drawing.Color.FromArgb(((int)(((byte)(208)))), ((int)(((byte)(208)))), ((int)(((byte)(208)))));
			this._groupBox_InputIOList.LabelGradientColorSecond = System.Drawing.Color.FromArgb(((int)(((byte)(240)))), ((int)(((byte)(240)))), ((int)(((byte)(240)))));
			this._groupBox_InputIOList.LabelHeight = 32;
			this._groupBox_InputIOList.LabelTextColor = System.Drawing.Color.Black;
			this._groupBox_InputIOList.Location = new System.Drawing.Point(0, 535);
			this._groupBox_InputIOList.Margin = new System.Windows.Forms.Padding(0);
			this._groupBox_InputIOList.Name = "_groupBox_InputIOList";
			this._groupBox_InputIOList.Padding = new System.Windows.Forms.Padding(3, 20, 3, 3);
			this._groupBox_InputIOList.Size = new System.Drawing.Size(578, 206);
			this._groupBox_InputIOList.TabIndex = 1374;
			this._groupBox_InputIOList.TabStop = false;
			this._groupBox_InputIOList.Text = "INPUT IO LIST";
			this._groupBox_InputIOList.TextAlign = Sys3Controls.EN_TEXTALIGN.MIDDLE_CENTER;
			this._groupBox_InputIOList.ThemeIndex = 0;
			this._groupBox_InputIOList.UseLabelBorder = true;
			this._groupBox_InputIOList.UseTitle = true;
			// 
			// _tableLayoutPanel_InputIOList
			// 
			this._tableLayoutPanel_InputIOList.ColumnCount = 2;
			this._tableLayoutPanel_InputIOList.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 76.74825F));
			this._tableLayoutPanel_InputIOList.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 23.25175F));
			this._tableLayoutPanel_InputIOList.Controls.Add(this.m_dgViewINPUT, 0, 0);
			this._tableLayoutPanel_InputIOList.Controls.Add(this.m_btnAddInput, 1, 1);
			this._tableLayoutPanel_InputIOList.Dock = System.Windows.Forms.DockStyle.Fill;
			this._tableLayoutPanel_InputIOList.Location = new System.Drawing.Point(3, 34);
			this._tableLayoutPanel_InputIOList.Margin = new System.Windows.Forms.Padding(0);
			this._tableLayoutPanel_InputIOList.Name = "_tableLayoutPanel_InputIOList";
			this._tableLayoutPanel_InputIOList.RowCount = 4;
			this._tableLayoutPanel_InputIOList.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 25F));
			this._tableLayoutPanel_InputIOList.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 25F));
			this._tableLayoutPanel_InputIOList.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 25F));
			this._tableLayoutPanel_InputIOList.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 25F));
			this._tableLayoutPanel_InputIOList.Size = new System.Drawing.Size(572, 169);
			this._tableLayoutPanel_InputIOList.TabIndex = 0;
			// 
			// m_btnAddInput
			// 
			this.m_btnAddInput.BorderWidth = 3;
			this.m_btnAddInput.ButtonClicked = false;
			this.m_btnAddInput.ClickedEmphasizeTextColor = System.Drawing.Color.White;
			this.m_btnAddInput.CustomClickedGradientFirstColor = System.Drawing.Color.White;
			this.m_btnAddInput.CustomClickedGradientSecondColor = System.Drawing.Color.White;
			this.m_btnAddInput.Description = "";
			this.m_btnAddInput.DisabledColor = System.Drawing.Color.DarkGray;
			this.m_btnAddInput.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			this.m_btnAddInput.HoverEmphasizeCustomColor = System.Drawing.Color.White;
			...
			this.m_btnAddInput.Location = new System.Drawing.Point(442, 45);
			...
			this._tableLayoutPanel_InputIOList.SetRowSpan(this.m_btnAddInput, 2);
			this.m_btnAddInput.Size = new System.Drawing.Size(127, 78);
			...
			this.m_btnAddInput.ThemeIndex = 0;
			this.m_btnAddInput.UseBorder = true;
			this.m_btnAddInput.UseClickedEmphasizeTextColor = false;
			this.m_btnAddInput.UseCustomizeClickedColor = false;
			this.m_btnAddInput.UseEdge = true;
			this.m_btnAddInput.UseHoverEmphasizeCustomColor = false;
			this.m_btnAddInput.UseImage = false;
			this.m_btnAddInput.UserHoverEmpahsize = false;
			...
			dataGridViewCellStyle61.Font = new System.Drawing.Font("맑은 고딕", 11F, System.Drawing.FontStyle.Bold);
			...
			this.m_dgViewOutput.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle61;
			...
			dataGridViewCellStyle62.Font = new System.Drawing.Font("맑은 고딕", 10F, System.Drawing.FontStyle.Bold);
			dataGridViewCellStyle62.ForeColor = System.Drawing.SystemColors.ControlText;
			dataGridViewCellStyle62.SelectionBackColor = System.Drawing.Color.FromArgb(((int)(((byte)(120)))), ((int)(((byte)(130)))), ((int)(((byte)(150)))));
			dataGridViewCellStyle62.SelectionForeColor = System.Drawing.SystemColors.HighlightText;
			dataGridViewCellStyle62.WrapMode = System.Windows.Forms.DataGridViewTriState.False;
			this.m_dgViewOutput.DefaultCellStyle = dataGridViewCellStyle62;
			...
			this.m_dgViewOutput.Location = new System.Drawing.Point(0, 0);
			this.m_dgViewOutput.Margin = new System.Windows.Forms.Padding(0);
			...
			dataGridViewCellStyle63.Font = new System.Drawing.Font("맑은 고딕", 11F);
			dataGridViewCellStyle63.ForeColor = System.Drawing.SystemColors.WindowText;
			dataGridViewCellStyle63.SelectionBackColor = System.Drawing.Color.FromArgb(((int)(((byte)(120)))), ((int)(((byte)(130)))), ((int)(((byte)(150)))));
			dataGridViewCellStyle63.SelectionForeColor = System.Drawing.SystemColors.HighlightText;
			dataGridViewCellStyle63.WrapMode = System.Windows.Forms.DataGridViewTriState.True;
			this.m_dgViewOutput.RowHeadersDefaultCellStyle = dataGridViewCellStyle63;
			...
			this._tableLayoutPanel_OutputList.SetRowSpan(this.m_dgViewOutput, 4);
			...
			this.m_dgViewOutput.Size = new System.Drawing.Size(439, 169);
			...
			this.m_btnAddOutput.ClickedEmphasizeTextColor = System.Drawing.Color.White;
			this.m_btnAddOutput.CustomClickedGradientFirstColor = System.Drawing.Color.White;
			this.m_btnAddOutput.CustomClickedGradientSecondColor = System.Drawing.Color.White;
			this.m_btnAddOutput.Description = "";
			this.m_btnAddOutput.DisabledColor = System.Drawing.Color.DarkGray;
			this.m_btnAddOutput.Dock = System.Windows.Forms.DockStyle.Fill;
			...
			this.m_btnAddOutput.HoverEmphasizeCustomColor = System.Drawing.Color.White;
			...
			this.m_btnAddOutput.Location = new System.Drawing.Point(442, 45);
			...
			this._tableLayoutPanel_OutputList.SetRowSpan(this.m_btnAddOutput, 2);
			this.m_btnAddOutput.Size = new System.Drawing.Size(127, 78);
			...
			this.m_btnAddOutput.ThemeIndex = 0;
			this.m_btnAddOutput.UseBorder = true;
			this.m_btnAddOutput.UseClickedEmphasizeTextColor = false;
			this.m_btnAddOutput.UseCustomizeClickedColor = false;
			this.m_btnAddOutput.UseEdge = true;
			this.m_btnAddOutput.UseHoverEmphasizeCustomColor = false;
			this.m_btnAddOutput.UseImage = false;
			this.m_btnAddOutput.UserHoverEmpahsize = false;
			this.m_btnAddOutput.UseSubFont = false;
			this.m_btnAddOutput.Click += new System.EventHandler(this.Click_OutputListButton);
			// 
			// _groupBox_OutputIOList
			// 
			this._groupBox_OutputIOList.BackGroundColor = System.Drawing.Color.WhiteSmoke;
			this._groupBox_OutputIOList.Controls.Add(this._tableLayoutPanel_OutputList);
			this._groupBox_OutputIOList.Dock = System.Windows.Forms.DockStyle.Fill;
			this._groupBox_OutputIOList.EdgeBorderStroke = 2;
			this._groupBox_OutputIOList.EdgeRadius = 2;
			this._groupBox_OutputIOList.LabelFont = new System.Drawing.Font("맑은 고딕", 10F, System.Drawing.FontStyle.Bold);
			this._groupBox_OutputIOList.LabelGradientColorFirst = System.Drawing.Color.FromArgb(((int)(((byte)(208)))), ((int)(((byte)(208)))), ((int)(((byte)(208)))));
			this._groupBox_OutputIOList.LabelGradientColorSecond = System.Drawing.Color.FromArgb(((int)(((byte)(240)))), ((int)(((byte)(240)))), ((int)(((byte)(240)))));
			this._groupBox_OutputIOList.LabelHeight = 32;
			this._groupBox_OutputIOList.LabelTextColor = System.Drawing.Color.Black;
			this._groupBox_OutputIOList.Location = new System.Drawing.Point(578, 535);
			this._groupBox_OutputIOList.Margin = new System.Windows.Forms.Padding(0);
			this._groupBox_OutputIOList.Name = "_groupBox_OutputIOList";
			this._groupBox_OutputIOList.Padding = new System.Windows.Forms.Padding(3, 20, 3, 3);
			this._groupBox_OutputIOList.Size = new System.Drawing.Size(578, 206);
			this._groupBox_OutputIOList.TabIndex = 1378;
			this._groupBox_OutputIOList.TabStop = false;
			this._groupBox_OutputIOList.Text = "OUTPUT IO LIST";
			this._groupBox_OutputIOList.TextAlign = Sys3Controls.EN_TEXTALIGN.MIDDLE_CENTER;
			this._groupBox_OutputIOList.ThemeIndex = 0;
			this._groupBox_OutputIOList.UseLabelBorder = true;
			this._groupBox_OutputIOList.UseTitle = true;
			// 
			// _tableLayoutPanel_OutputList
			// 
			this._tableLayoutPanel_OutputList.ColumnCount = 2;
			this._tableLayoutPanel_OutputList.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 76.74825F));
			this._tableLayoutPanel_OutputList.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 23.25175F));
			this._tableLayoutPanel_OutputList.Controls.Add(this.m_dgViewOutput, 0, 0);
			this._tableLayoutPanel_OutputList.Controls.Add(this.m_btnAddOutput, 1, 1);
			this._tableLayoutPanel_OutputList.Dock = System.Windows.Forms.DockStyle.Fill;
			this._tableLayoutPanel_OutputList.Location = new System.Drawing.Point(3, 34);
			this._tableLayoutPanel_OutputList.Margin = new System.Windows.Forms.Padding(0);
			this._tableLayoutPanel_OutputList.Name = "_tableLayoutPanel_OutputList";
			this._tableLayoutPanel_OutputList.RowCount = 4;
			this._tableLayoutPanel_OutputList.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 25F));
			this._tableLayoutPanel_OutputList.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 25F));
			this._tableLayoutPanel_OutputList.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 25F));
			this._tableLayoutPanel_OutputList.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 25F));
			this._tableLayoutPanel_OutputList.Size = new System.Drawing.Size(572, 169);
			this._tableLayoutPanel_OutputList.TabIndex = 1;
			// 
			...
			this._tableLayoutPanel_Main.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 50F));
			this._tableLayoutPanel_Main.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 50F));
			this._tableLayoutPanel_Main.Controls.Add(this._tableLayoutPanel_Timeout, 1, 3);
			this._tableLayoutPanel_Main.Controls.Add(this._tableLayoutPanel_Delay, 0, 3);
			this._tableLayoutPanel_Main.Controls.Add(this.m_groupList, 0, 0);
			this._tableLayoutPanel_Main.Controls.Add(this.m_groupConfiguration, 0, 1);
			this._tableLayoutPanel_Main.Controls.Add(this._groupBox_InputIOList, 0, 2);
			this._tableLayoutPanel_Main.Controls.Add(this._groupBox_OutputIOList, 1, 2);
			this._tableLayoutPanel_Main.Controls.Add(this.tableLayoutPanel1, 0, 5);
			...
			this._tableLayoutPanel_Main.RowCount = 6;
			this._tableLayoutPanel_Main.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 45.19633F));
			this._tableLayoutPanel_Main.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 14.40079F));
			this._tableLayoutPanel_Main.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 22.9305F));
			this._tableLayoutPanel_Main.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 5.975223F));
			this._tableLayoutPanel_Main.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 1.195045F));
			this._tableLayoutPanel_Main.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 10.30211F));
			this._tableLayoutPanel_Main.Size = new System.Drawing.Size(1156, 900);
			this._tableLayoutPanel_Main.TabIndex = 1379;
			// 
			// _tableLayoutPanel_Timeout
			// 
			this._tableLayoutPanel_Timeout.ColumnCount = 2;
			this._tableLayoutPanel_Timeout.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 38.15638F));
			this._tableLayoutPanel_Timeout.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 61.84362F));
			this._tableLayoutPanel_Timeout.Controls.Add(this.m_lblTimeout, 0, 1);
			this._tableLayoutPanel_Timeout.Controls.Add(this.m_labelTimeout, 1, 1);
			this._tableLayoutPanel_Timeout.Dock = System.Windows.Forms.DockStyle.Fill;
			this._tableLayoutPanel_Timeout.Location = new System.Drawing.Point(583, 741);
			this._tableLayoutPanel_Timeout.Margin = new System.Windows.Forms.Padding(5, 0, 5, 0);
			this._tableLayoutPanel_Timeout.Name = "_tableLayoutPanel_Timeout";
			this._tableLayoutPanel_Timeout.RowCount = 3;
			this._tableLayoutPanel_Timeout.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 4.710145F));
			this._tableLayoutPanel_Timeout.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 90.57971F));
			this._tableLayoutPanel_Timeout.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 4.710145F));
			this._tableLayoutPanel_Timeout.Size = new System.Drawing.Size(568, 53);
			this._tableLayoutPanel_Timeout.TabIndex = 1381;
			// 
			// _tableLayoutPanel_Delay
			// 
			this._tableLayoutPanel_Delay.ColumnCount = 2;
			this._tableLayoutPanel_Delay.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 38.15638F));
			this._tableLayoutPanel_Delay.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 61.84362F));
			this._tableLayoutPanel_Delay.Controls.Add(this.m_lblDelay, 0, 1);
			this._tableLayoutPanel_Delay.Controls.Add(this.m_labelDelay, 1, 1);
			this._tableLayoutPanel_Delay.Dock = System.Windows.Forms.DockStyle.Fill;
			this._tableLayoutPanel_Delay.Location = new System.Drawing.Point(5, 741);
			this._tableLayoutPanel_Delay.Margin = new System.Windows.Forms.Padding(5, 0, 5, 0);
			this._tableLayoutPanel_Delay.Name = "_tableLayoutPanel_Delay";
			this._tableLayoutPanel_Delay.RowCount = 3;
			this._tableLayoutPanel_Delay.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 4.710145F));
			this._tableLayoutPanel_Delay.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 90.57971F));
			this._tableLayoutPanel_Delay.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 4.710145F));
			this._tableLayoutPanel_Delay.Size = new System.Drawing.Size(568, 53);
			this._tableLayoutPanel_Delay.TabIndex = 1380;
			// 
			// tableLayoutPanel1
			// 
			this.tableLayoutPanel1.ColumnCount = 13;
			this._tableLayoutPanel_Main.SetColumnSpan(this.tableLayoutPanel1, 2);
			this.tableLayoutPanel1.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 3.158035F));
			this.tableLayoutPanel1.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 12.02997F));
			this.tableLayoutPanel1.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 12.02997F));
			this.tableLayoutPanel1.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 3.158035F));
			this.tableLayoutPanel1.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 12.02998F));
			this.tableLayoutPanel1.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 12.02997F));
			this.tableLayoutPanel1.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 3.158035F));
			...
			this.tableLayoutPanel1.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 12.02998F));
			this.tableLayoutPanel1.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 3.158035F));
			this.tableLayoutPanel1.Controls.Add(this.m_btnEnable, 1, 1);
			this.tableLayoutPanel1.Controls.Add(this.m_btnBackward, 11, 1);
			this.tableLayoutPanel1.Controls.Add(this.m_btnDisable, 2, 1);
			this.tableLayoutPanel1.Controls.Add(this.m_btnForward, 10, 1);
			this.tableLayoutPanel1.Controls.Add(this.m_btnAdd, 4, 1);
			this.tableLayoutPanel1.Controls.Add(this.m_btnRepeat, 8, 1);
			this.tableLayoutPanel1.Controls.Add(this.m_btnRemove, 5, 1);
			this.tableLayoutPanel1.Controls.Add(this.m_ledRepeat, 7, 1);
			...
			this.tableLayoutPanel1.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 4.545455F));
			this.tableLayoutPanel1.Size = new System.Drawing.Size(1156, 96);
			this.tableLayoutPanel1.TabIndex = 1382;
			// 
			// m_btnExtend
			// 
			...
			this.m_btnExtend.Location = new System.Drawing.Point(1090, 1);
			...
			this.m_btnExtend.Size = new System.Drawing.Size(41, 33);
			...
			this.m_btnExtend.TabIndex = 1180;
			...
			this.m_btnExtend.Click += new System.EventHandler(this.m_btnExtend_Click);
			// 
			// lbl_Filtering
			// 
			...
			this.lbl_Filtering.Location = new System.Drawing.Point(561, 2);
			...
			this.lbl_Filtering.Size = new System.Drawing.Size(529, 32);
			...
			this.lbl_Filtering.TabIndex = 1350;
			...
			this._groupBox_InputIOList.ResumeLayout(false);
			this._tableLayoutPanel_InputIOList.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.m_dgViewOutput)).EndInit();
			this._groupBox_OutputIOList.ResumeLayout(false);
			this._tableLayoutPanel_OutputList.ResumeLayout(false);
			this._tableLayoutPanel_Main.ResumeLayout(false);
			this._tableLayoutPanel_Timeout.ResumeLayout(false);
			this._tableLayoutPanel_Delay.ResumeLayout(false);
        ...
        private Sys3Controls.Sys3GroupBoxContainer _groupBox_InputIOList;
        ...
        private Sys3Controls.Sys3GroupBoxContainer _groupBox_OutputIOList;
        private System.Windows.Forms.TableLayoutPanel _tableLayoutPanel_Main;
        private System.Windows.Forms.TableLayoutPanel _tableLayoutPanel_InputIOList;
        private System.Windows.Forms.TableLayoutPanel _tableLayoutPanel_OutputList;
        private System.Windows.Forms.TableLayoutPanel _tableLayoutPanel_Configuration;
        private System.Windows.Forms.TableLayoutPanel _tableLayoutPanel_Delay;
        private System.Windows.Forms.TableLayoutPanel _tableLayoutPanel_Timeout;
