namespace FrameOfSystem3.Views.Recipe.Options
{
	partial class RecipeOptionProcess
	{
		/// <summary> 
		/// 필수 디자이너 변수입니다.
		/// </summary>
		...
		private void InitializeComponent()
		{
			...
			this.sys3Label7.Location = new System.Drawing.Point(6, 37);
			...
			this.sys3Label7.Size = new System.Drawing.Size(334, 30);
			...
			this.sys3Label7.TabIndex = 20666;
			this.sys3Label7.Tag = "";
			this.sys3Label7.Text = "CALCULATOR";
			...
			this.sys3Label6.Location = new System.Drawing.Point(6, 68);
			...
			this.sys3Label6.TabIndex = 20666;
			this.sys3Label6.Tag = "";
			this.sys3Label6.Text = "SELECTION LIST";
			...
			this.customParameterLabel1.Location = new System.Drawing.Point(341, 68);
			...
			this.customParameterLabel1.ParameterName = "Option_SelectionList";
			...
			this.customParameterLabel1.ParameterType = FrameOfSystem3.Recipe.EN_RECIPE_TYPE.PROCESS;
			this.customParameterLabel1.ParameterUNIT = "";
			this.customParameterLabel1.SelectionList = Define.DefineEnumProject.SelectionList.EN_SELECTIONLIST.TRUE_FALSE;
			...
			this.customParameterLabel1.TabIndex = 20667;
			...
			this.customParameterLabel4.Location = new System.Drawing.Point(341, 37);
			...
			this.customParameterLabel4.Margin = new System.Windows.Forms.Padding(1, 1, 0, 0);
			...
			this.customParameterLabel4.ParameterDefaultValue = "0";
			this.customParameterLabel4.ParameterIndex = 0;
			this.customParameterLabel4.ParameterMAX = "10000";
			this.customParameterLabel4.ParameterMIN = "-10000";
			this.customParameterLabel4.ParameterName = "Option_Calculate";
			this.customParameterLabel4.ParameterSettingType = FrameOfSystem3.Component.EN_LABEL_PARAMETER_TYPE.CALCULATE_DOUBLE;
			this.customParameterLabel4.ParameterStorage = "";
			this.customParameterLabel4.ParameterStored = false;
			this.customParameterLabel4.ParameterType = FrameOfSystem3.Recipe.EN_RECIPE_TYPE.PROCESS;
			this.customParameterLabel4.ParameterUNIT = "mm";
			this.customParameterLabel4.SelectionList = Define.DefineEnumProject.SelectionList.EN_SELECTIONLIST.NONE;
			this.customParameterLabel4.Size = new System.Drawing.Size(154, 30);
			...
			this.customParameterLabel4.TabIndex = 20667;
			this.customParameterLabel4.Tag = "";
			this.customParameterLabel4.TaskName = "Sample";
			...
			this.customParameterLabel4.UseUnitFont = false;
			// 
			// tgl_sample
			// 
			...
			this.sys3Label2.Location = new System.Drawing.Point(6, 99);
			...
			this.sys3Label2.TabIndex = 20666;
			this.sys3Label2.Tag = "";
			this.sys3Label2.Text = "KEY BOARD";
			...
			this.customParameterLabel2.Location = new System.Drawing.Point(341, 99);
			...
			this.customParameterLabel2.ParameterName = "Option_Keyboard";
			...
			this.customParameterLabel2.ParameterType = FrameOfSystem3.Recipe.EN_RECIPE_TYPE.PROCESS;
			this.customParameterLabel2.ParameterUNIT = "";
			this.customParameterLabel2.SelectionList = Define.DefineEnumProject.SelectionList.EN_SELECTIONLIST.TRUE_FALSE;
			this.customParameterLabel2.Size = new System.Drawing.Size(452, 30);
			...
			this.customParameterLabel2.TabIndex = 20667;
			...
			this.sys3Label3.Location = new System.Drawing.Point(6, 130);
			...
			this.sys3Label3.TabIndex = 20666;
			this.sys3Label3.Tag = "";
			this.sys3Label3.Text = "PATH";
			...
			this.customParameterLabel3.Location = new System.Drawing.Point(341, 130);
			...
			this.customParameterLabel3.ParameterMAX = "1";
			this.customParameterLabel3.ParameterMIN = "0";
			this.customParameterLabel3.ParameterName = "Option_Path";
			this.customParameterLabel3.ParameterSettingType = FrameOfSystem3.Component.EN_LABEL_PARAMETER_TYPE.FOLDER_DIALOG;
			this.customParameterLabel3.ParameterStorage = "";
			this.customParameterLabel3.ParameterStored = false;
			this.customParameterLabel3.ParameterType = FrameOfSystem3.Recipe.EN_RECIPE_TYPE.PROCESS;
			this.customParameterLabel3.ParameterUNIT = "";
			this.customParameterLabel3.SelectionList = Define.DefineEnumProject.SelectionList.EN_SELECTIONLIST.TRUE_FALSE;
			this.customParameterLabel3.Size = new System.Drawing.Size(452, 30);
			...
			this.customParameterLabel3.TabIndex = 20667;
			...
			// customJogButton1
			// 
			this.customJogButton1.AxisCount = 2;
			this.customJogButton1.AxisName1 = "SAMPLE";
			this.customJogButton1.AxisName2 = "NONE";
			this.customJogButton1.BorderWidth = 2;
			this.customJogButton1.ButtonClicked = false;
			this.customJogButton1.ClickedEmphasizeTextColor = System.Drawing.Color.White;
			this.customJogButton1.CustomClickedGradientFirstColor = System.Drawing.Color.BlanchedAlmond;
			this.customJogButton1.CustomClickedGradientSecondColor = System.Drawing.Color.Gold;
			this.customJogButton1.Description = "";
			this.customJogButton1.DisabledColor = System.Drawing.Color.DarkGray;
			this.customJogButton1.EdgeRadius = 5;
			this.customJogButton1.GradientAngle = 60F;
			this.customJogButton1.GradientFirstColor = System.Drawing.Color.Silver;
			this.customJogButton1.GradientSecondColor = System.Drawing.Color.Gray;
			this.customJogButton1.HoverEmphasizeCustomColor = System.Drawing.Color.Firebrick;
			this.customJogButton1.ImagePosition = new System.Drawing.Point(0, 0);
			this.customJogButton1.ImageSize = new System.Drawing.Point(0, 0);
			this.customJogButton1.JogTitle = "JOG SAMPLE";
			this.customJogButton1.LoadImage = null;
			this.customJogButton1.Location = new System.Drawing.Point(496, 37);
			this.customJogButton1.MainFont = new System.Drawing.Font("맑은 고딕", 12F, System.Drawing.FontStyle.Bold);
			this.customJogButton1.MainFontColor = System.Drawing.Color.White;
			this.customJogButton1.Margin = new System.Windows.Forms.Padding(1, 1, 0, 0);
			this.customJogButton1.Name = "customJogButton1";
			this.customJogButton1.ParameterName1 = "Option_Calculate";
			this.customJogButton1.ParameterName2 = "";
			this.customJogButton1.ParameterType1 = FrameOfSystem3.Recipe.EN_RECIPE_TYPE.PROCESS;
			this.customJogButton1.ParameterType2 = FrameOfSystem3.Recipe.EN_RECIPE_TYPE.PROCESS;
			this.customJogButton1.Size = new System.Drawing.Size(65, 30);
			this.customJogButton1.SubFont = new System.Drawing.Font("맑은 고딕", 10F);
			this.customJogButton1.SubFontColor = System.Drawing.Color.Black;
			this.customJogButton1.SubText = "";
			this.customJogButton1.TabIndex = 21080;
			this.customJogButton1.TaskName1 = "Sample";
			this.customJogButton1.TaskName2 = "Sample";
			this.customJogButton1.Text = "JOG";
			this.customJogButton1.TextAlignMain = Sys3Controls.EN_TEXTALIGN.MIDDLE_CENTER;
			this.customJogButton1.TextAlignSub = Sys3Controls.EN_TEXTALIGN.MIDDLE_CENTER;
			this.customJogButton1.ThemeIndex = 0;
			this.customJogButton1.UseBorder = true;
			this.customJogButton1.UseClickedEmphasizeTextColor = false;
			this.customJogButton1.UseCustomizeClickedColor = true;
			this.customJogButton1.UseEdge = true;
			this.customJogButton1.UseHoverEmphasizeCustomColor = true;
			this.customJogButton1.UseImage = false;
			this.customJogButton1.UserHoverEmpahsize = true;
			this.customJogButton1.UseSubFont = false;
			// 
			// customActionButton1
			// 
			this.customActionButton1.ActionName = "TEST_ACTION";
			this.customActionButton1.BorderWidth = 2;
			...
			this.customActionButton1.CustomClickedGradientFirstColor = System.Drawing.Color.BlanchedAlmond;
			this.customActionButton1.CustomClickedGradientSecondColor = System.Drawing.Color.Gold;
			this.customActionButton1.Description = "";
			this.customActionButton1.DisabledColor = System.Drawing.Color.Silver;
			this.customActionButton1.EdgeRadius = 5;
			this.customActionButton1.GradientAngle = 60F;
			this.customActionButton1.GradientFirstColor = System.Drawing.Color.DeepSkyBlue;
			this.customActionButton1.GradientSecondColor = System.Drawing.Color.SteelBlue;
			this.customActionButton1.HoverEmphasizeCustomColor = System.Drawing.Color.Firebrick;
			...
			this.customActionButton1.Location = new System.Drawing.Point(844, 97);
			this.customActionButton1.MainFont = new System.Drawing.Font("맑은 고딕", 12F, System.Drawing.FontStyle.Bold);
			this.customActionButton1.MainFontColor = System.Drawing.Color.White;
			this.customActionButton1.Margin = new System.Windows.Forms.Padding(1, 1, 0, 0);
			this.customActionButton1.Name = "customActionButton1";
			this.customActionButton1.Size = new System.Drawing.Size(271, 59);
			...
			this.customActionButton1.TabIndex = 21081;
			this.customActionButton1.Tag = "";
			this.customActionButton1.TaskName = "Sample";
			this.customActionButton1.Text = "SAMPLE MANUAL ACTION";
			...
			this.customActionButton1.UseCustomizeClickedColor = true;
			this.customActionButton1.UseEdge = true;
			this.customActionButton1.UseHoverEmphasizeCustomColor = true;
			this.customActionButton1.UseImage = false;
			this.customActionButton1.UserHoverEmpahsize = true;
			this.customActionButton1.UseSubFont = false;
			// 
			// customActionButton5
			// 
			this.customActionButton5.ActionName = "TEST_ACTION";
			this.customActionButton5.BorderWidth = 2;
			this.customActionButton5.ButtonClicked = false;
			this.customActionButton5.ClickedEmphasizeTextColor = System.Drawing.Color.White;
			this.customActionButton5.CustomClickedGradientFirstColor = System.Drawing.Color.BlanchedAlmond;
			this.customActionButton5.CustomClickedGradientSecondColor = System.Drawing.Color.Gold;
			this.customActionButton5.Description = "";
			this.customActionButton5.DisabledColor = System.Drawing.Color.Silver;
			this.customActionButton5.EdgeRadius = 5;
			this.customActionButton5.GradientAngle = 60F;
			this.customActionButton5.GradientFirstColor = System.Drawing.Color.DeepSkyBlue;
			this.customActionButton5.GradientSecondColor = System.Drawing.Color.SteelBlue;
			this.customActionButton5.HoverEmphasizeCustomColor = System.Drawing.Color.Firebrick;
			this.customActionButton5.ImagePosition = new System.Drawing.Point(0, 0);
			this.customActionButton5.ImageSize = new System.Drawing.Point(0, 0);
			this.customActionButton5.LoadImage = null;
			this.customActionButton5.Location = new System.Drawing.Point(844, 37);
			this.customActionButton5.MainFont = new System.Drawing.Font("맑은 고딕", 12F, System.Drawing.FontStyle.Bold);
			this.customActionButton5.MainFontColor = System.Drawing.Color.White;
			this.customActionButton5.Margin = new System.Windows.Forms.Padding(1, 1, 0, 0);
			this.customActionButton5.Name = "customActionButton5";
			this.customActionButton5.Size = new System.Drawing.Size(271, 59);
			this.customActionButton5.SubFont = new System.Drawing.Font("맑은 고딕", 10F);
			this.customActionButton5.SubFontColor = System.Drawing.Color.Black;
			this.customActionButton5.SubText = "";
			this.customActionButton5.TabIndex = 21082;
			this.customActionButton5.Tag = "";
			this.customActionButton5.TaskName = "Sample";
			this.customActionButton5.Text = "SAMPLE AUTO ACTION";
			this.customActionButton5.TextAlignMain = Sys3Controls.EN_TEXTALIGN.MIDDLE_CENTER;
			this.customActionButton5.TextAlignSub = Sys3Controls.EN_TEXTALIGN.MIDDLE_CENTER;
			this.customActionButton5.ThemeIndex = 0;
			this.customActionButton5.UseBorder = true;
			this.customActionButton5.UseClickedEmphasizeTextColor = false;
			this.customActionButton5.UseCustomizeClickedColor = true;
			this.customActionButton5.UseEdge = true;
			this.customActionButton5.UseHoverEmphasizeCustomColor = true;
			this.customActionButton5.UseImage = false;
		...
		private Component.CustomParameterLabel customParameterLabel4;
